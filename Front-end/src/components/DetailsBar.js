...
const DetailsBar = () => {
    return (
        <DetailsBarWrapper>
            ...
            <div>
                <ContactsWrapper href="tel:+84987452905">
                    <Icon.Phone size={15} color="rgb(252, 113, 137)" />
                    <ContactText>+84987452905</ContactText>
                </ContactsWrapper>

                <ContactsWrapper href="mailto:dantranvan509@gmail.com">
                    <Icon.Mail size={15} color="rgb(252, 113, 137)" />
                    <ContactText>dantranvan509@gmail.com</ContactText>
                </ContactsWrapper>
            </div>
