...
import { putProduct } from "../../services/ProductServices";
...
const EditProductForm = ({ product }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await putProduct(product._id, data);
  ...
  return (
    <Container className="mt-4">
      <Card className="shadow-lg p-4">
        <Card.Title className="text-center mb-4">Edit Product</Card.Title>
